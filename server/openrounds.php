<?php
/*   openrounds.php: recupera las partidas abiertas para un juego determinado
 * 
 ...
 */
    ...
    if (isPlayerIdAccesible() && isset($_REQUEST["gameid"])) {
        getrounds($_REQUEST["gameid"], RoundStates::Open);
    }
    else {
        file_put_contents (get_log_filename(), "Faltan parámetros o no logeado.", FILE_APPEND);
    }
